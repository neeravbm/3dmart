...
(function ($, THREE) {
    Drupal.behaviors.model3d_integration_render_product_display = {
        attach: function(context, settings) {
            ...
            var scene_entity = settings.model3d_integration.scene.scene_entity;
            var meshes = [];
            $.each(scene_entity.objects, function(index_o, element_o) {
                var mesh = loadObject(element_o.object, $);
                operate(mesh, element_o.object.operations.concat(element_o.operations), $);
